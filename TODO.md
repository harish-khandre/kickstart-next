...
4. back end tech ? trpc or graphql or rest api ? 
5. orm ? prisma or drizzle or none  ? 
6. database ? mongodb or postgres or mysql or none ? (depending on db create local db using docker) 
7. authentication ? auth.js or lucia or none ? (if auth.js use github.com/harish-khandre/auth template)
8. providers ? multi select : 1. google 2. discord  3. apple 4. github 
9. git ? boolean
0. sst? 
